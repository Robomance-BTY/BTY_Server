...
public class ApplicationLoginService {
    ...
    public ApplicationLoginService(BookRentalService bookRentalService, UserRepository userRepository, RentalRepository rentalRepository, ReservationRepository reservationRepository) {
